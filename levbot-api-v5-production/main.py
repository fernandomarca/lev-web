...
from fastapi import FastAPI, UploadFile, File, HTTPException, Header, Depends, status, Response, BackgroundTasks
    ...
    if file.content_type == "audio/mpeg":
        try:
            ...
            if os.path.exists("output.mp3"):
                ...
                os.rename("output.mp3", f"output_{timestamp}.mp3")
